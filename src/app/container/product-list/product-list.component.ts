...
export class ProductListComponent {
  ...
  allProducts: number = this.products.length;
  inStockProducts = this.products.filter((prod) => prod.is_in_inventory).length;
  outOfStockProducts = this.allProducts - this.inStockProducts;
}
